...
| November 18 - 22 | Project review meeting with TA or Instructor |
...
You start by filling out this google form to define your teams and project proposal. [This form]() (link coming soon) should be filled out by Friday November 15, 2019 at 11:59pm. The title can be changed at a later date. Each team (or individual if working alone) will only need to submit one form. Based on your proposals, a TA or instructor will be assigned to your team who will guide you through the rest of the project. You will schedule a project review meeting with your TA or instructor the following week. Make sure all of your team members are present at the meeting.
...
#### How to submit RMarkdown, HTML files, Website and Screencast (due Friday, December 13)
...
3. Fill out this [google form to submit the links to the website and screencast]()  (link coming soon). **If we cannot access the website or screencast, we cannot grade it**. The website should include a description and links to accessing the data and location of your GitHub repository. 

#### How to submit the Peer Assessment (due Sunday, December 15)
Each individual team member needs to fill out this [google form for the peer evaluation]()  (link coming soon). Your individual project score will take into account your self and peer assessment.
